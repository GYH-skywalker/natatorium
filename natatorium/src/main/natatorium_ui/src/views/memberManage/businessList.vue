...
export default {
  ...
  data(){
    return{
      fields: [
        {prop:'packageName',label:'套餐名称',width:80},
        {prop:'coachName',label:'教练名称',width:80},
        {prop:'cardNumber',label:'会员卡号',width:150},
        {prop:'createTime',label:'办理时间',width:150},
        {prop:'cardUserName',label:'会员名称',width:80},
        {prop:'cardUserGender',label:'会员性别',width:80},
        {prop:'cardUserAge',label:'年龄',width:80},
        {prop:'cardUserPhone',label:'手机号',width:null}
      ],
      fileType:'',
      tableData:[],
      currentPage:1,
