<template>
  <div>
    ...
    <nata-dialog @confirm="confirm" title="新增项目" width="45%">
      <el-form
          label-position="left"
          label-width="70px"
          title="消费项目"
        ...
        <el-form-item label="门票名称">
          <el-input v-model="Form.ticketName"></el-input>
        </el-form-item>
        <el-form-item label="门票金额">
          <el-input v-model="Form.ticketPrice"></el-input>
        </el-form-item>
        <el-form-item label="门票时限(天)">
          <el-input v-model="Form.ticketTimeLimit"></el-input>
        </el-form-item>
...
export default {
  ...
  data(){
    return{
      fields: [
        {prop:'ticketName',label:'门票名称',width:120},
        {prop:'ticketPrice',label:'门票金额',width:120},
        {prop:'ticketTimeLimit',label:'门票时限(天)',width:120},
